#EXACTLY THE SAME AS CAMILLE'S "initialFileCreator.py" BUT WITH A THIRD LINE 'ope' AT EACH TRIAL DESCRIPTION
...
for g in range(1, group+1):
    ...
    for n in range(0, lenght):
        ...
        if n < 6:
            ...
            training = "0"
        if n%2 == 0:
            file.write("g0" + str(g) + ";ope;C;" + str(nb) + ";" + training + ";" + groupMove[g-1][0] + ";" + "none;" + wall + ";" + str(cardList[n]) + ";\n")
    ...
    for n in range(0, lenght-6):
        ...
        training = "0"
        if n%2 == 0:
            file.write("g0" + str(g) + ";ope;C;" + str(nb) + ";" + training + ";" + groupMove[g-1][0] + ";" + "none;" + wall + ";" + str(cardList[lenght-7-n]) + ";\n")
    ...
    for n in range(lenght, 2*lenght):
        ...
        if n-lenght < 6:
            ...
            training = "0"
        if n%2 == 0:
            file.write("g0" + str(g) + ";ope;C;" + str(nb) + ";" + training + ";" + groupMove[g-1][1] + ";" + "none;" + wall + ";" + str(cardList[n]) + ";\n")
    ...
    for n in range(lenght, 2*lenght-6):
        ...
        if n-lenght < 2*lenght - 6:
            training = "0"
            if n%2 == 0:
                file.write("g0" + str(g) + ";ope;C;" + str(nb) + ";" + training + ";" + groupMove[g-1][1] + ";" + "none;" + wall + ";" + str(cardList[lenght + 2*lenght-7-n]) + ";\n")
    ...
    for n in range(2*lenght, 3*lenght):
        ...
        if n-2*lenght < 6:
            ...
            training = "0"
        if n%2 == 0:
            file.write("g0" + str(g) + ";ope;C;" + str(nb) + ";" + training + ";" + groupMove[g-1][2] + ";" + "none;" + wall + ";" + str(cardList[n]) + ";\n")
    ...
    for n in range(2*lenght, 3*lenght-6):
        ...
        if n-2*lenght < 3*lenght - 6:
            training = "0"
            if n%2 == 0:
                file.write("g0" + str(g) + ";ope;C;" + str(nb) + ";" + training + ";" + groupMove[g-1][2] + ";" + "none;" + wall + ";" + str(cardList[2*lenght + 3*lenght-7-n]) + ";\n")
