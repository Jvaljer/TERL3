...
public class Experiment {
    ...
    public void IncrementTrialNb(){
        trial_nb += 1;
        if (trial_nb - 2 >= 0 && trials[trial_nb - 2].group != "#pause"){
            trials[trial_nb - 2].card.transform.GetChild(1).gameObject.SetActive(false);
            trials[trial_nb - 2].card.transform.GetChild(1).GetComponent<Renderer>().material = player_script.light_red;
    ...
    public void NextTrial(){
        if(!trial_running){
            ...
            if(trials[trial_nb].task == "Search"){
                ...
                if(trials[trial_nb].training == "1"){
                    ctrl_tp.menu.transform.Find("move_mode_text").GetComponent<TextMesh>().text = "Navigate " + trials[trial_nb].move_mode + "\n Training";
                } else {
                    ctrl_tp.menu.transform.Find("move_mode_text").GetComponent<TextMesh>().text = "Navigate " + trials[trial_nb].move_mode;
                }
            ...
            if(trials[trial_nb].group == "#pause"){
                ...
                IncrementTrialNb();
                ctrl_tp.menu.transform.Find("move_mode_text").GetComponent<TextMesh>().text = "Next move " + trials[trial_nb].move_mode;
                SetInfoLocation();
                ctrl_tp.menu.SetActive(true);
            } else {
                SetInfoLocation();
